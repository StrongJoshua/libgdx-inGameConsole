...
public interface Console {
	...
	/**
	 * @param numEntries
	 *            maximum number of entries the console will hold.
	 */
	...
	/**
	 * Makes the console also log to the System when {@link Console#log(String)}
	 * is called.
	 * 
	 * @param log
	 *            to the system
	 ...
	 * 
	 * @param wPct
	 *            width of the console as a percent of screen width
	 * @param hPct
	 *            height of the console as a percent of screen height
	 */
	...
	/**
	 * Set position of the lower left corner of the console as a percent of
	 * screen size
	 * 
	 * @param xPosPct
	 *            Percentage for the x position relative to the screen size.
	 * @param yPosPct
	 *            Percentage for the y position relative to the screen size.
	 */
	public void setPositionPercent(float xPosPct, float yPosPct);

	/**
	 * Call this method if you changed the input processor while this console
	 * was active.
	 */
	 ...
	 * 
	 * @param retain
	 *            True if you want position and size percentages to be kept.
	 */
	 ...
	 * @param level
	 *            The {@link LogLevel} of the log entry.
	 * @see LogLevel
	 */
	 ...
	 *
	 * @param file
	 *            The relative path to the file to print to. This method uses
	 ...
	 *
	 * @param fh
	 *            The {@link FileHandle} that links to the file to be written
	 *            to. Note that <code>classpath</code> and <code>internal</code>
	...
	/**
	 * @param disabled
	 *            True if the console should be disabled (unable to be shown or
	 *            used). False otherwise.
	 */
	public void setDisabled(boolean disabled);

	/**
	 * Gets the console's display key. If the console is enabled, the console
	 * will be shown upon this key being pressed.<br>
	...
	/**
	 * @param code
	 *            The new key's ID. Cannot be {@link Keys#ENTER}.
	 * @see Console#getDisplayKeyID()
	 */
	public void setDisplayKeyID(int code);

	/**
	 * Sets this console's {@link CommandExecutor}. Its methods are the methods
	 * that are referenced within the console. Can be set to null, but this will
	 * result in no commands being fired.
	 * 
	 * @param commandExec
	 */
	...
	/**
	 * Resets the {@link InputProcessor} to the one that was the default before
	 * this console object was created.
	 */
	public void dispose();
	 ...
	 * 
	 * @param enabled
	 *            - if true, commands annotated with {@link HiddenCommand} can
	 *            be executed
	 */
	 ...
	 * 
	 * @param enabled
	 *            - if true, commands annotated with {@link HiddenCommand} show
