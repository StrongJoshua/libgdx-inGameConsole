...
/** Extend this class and fill it with methods (also <code>public</code>)
 * that you wish to
 * have work with the {@link Console}. Then call
 * {@link Console#setCommandExecutor(CommandExecutor)}.<br>
 * <br>
 * <b>Notes</b><br>
 * <ul>
 * <li>Arguments <i><b>must</b></i> be primitive types (the only exception
 * being {@link String}).</li>
 * <li>No two methods, of the same name, can have the same number of
 * parameters. Make multiple methods with more specific names if
...
public abstract class CommandExecutor {
	 ...
	 * the application.*/
	@ConsoleDoc(description = "Deselects the console text field. Click to " +
			"re-select.")
